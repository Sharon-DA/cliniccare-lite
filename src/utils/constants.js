...
export const APPOINTMENT_STATUS = {
  ...
  LAB: 'lab',
  LAB_RESULTS_READY: 'lab_results_ready',  // Lab results ready for doctor review
  PHARMACY: 'pharmacy',
  COMPLETED: 'completed',
  NO_SHOW: 'no_show',
  CANCELLED: 'cancelled'
...
export const APPOINTMENT_STATUS_LABELS = {
  ...
  [APPOINTMENT_STATUS.LAB]: 'In Lab',
  [APPOINTMENT_STATUS.LAB_RESULTS_READY]: 'Lab Results Ready',
...
export const APPOINTMENT_STATUS_COLORS = {
  ...
  [APPOINTMENT_STATUS.LAB_RESULTS_READY]: 'bg-emerald-100 text-emerald-700',
